...
// const SubmitButton = ({ isLoading, isEdit }) => {
//   return (
//     <Button type="submit" disabled={isLoading}>
...
// const AddJob = ({ open, onOpenChange, onSubmit: parentSubmit, editJob = null }) => {
//   const [isLoading, setIsLoading] = useState(false);
...
//     setIsLoading(true);
//     setTimeout(() => {
//       parentSubmit(data); // Pass to parent
//       setIsLoading(false);
//       closeModel();
//     }, 1000);
//   };
...
//             <DialogDescription className="flex items-center gap-2 text-sm text-gray-500 mt-1">
//               <FaInfoCircle className="text-blue-500" />
//               {editJob ? "Update the job details below." : "Fill out the details to post a new job opening."}
//             </DialogDescription>
//           </DialogHeader>
...
//               Cancel
//             </Button>
//             <SubmitButton isLoading={isLoading} isEdit={!!editJob} />
//           </DialogFooter>
//         </form>
//       </DialogContent>
//     </Dialog>
...
// const AddJob = ({ open, onOpenChange, onSubmit, editingData }) => {
//   const [isLoading, setIsLoading] = useState(false);
...
//             <div className="flex flex-col gap-2">
//               <label className="form-label text-sm font-medium">Experience</label>
//               <Input type="number" {...register("experience")} />
//             </div>
...
//               Cancel
//             </Button>
//             <SubmitButton isLoading={isLoading} isEdit={!!editingData} />
//           </DialogFooter>
//         </form>
//       </DialogContent>
//     </Dialog>
